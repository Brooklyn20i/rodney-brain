...
Fork of Cadence/agent/cadence_bridge.py pointed at the Cadence Fitness
Supabase project (a separate project from Cadence Work and Financial).
...
Required configuration:
  CADENCE_FITNESS_SUPABASE_URL       public project URL
  CADENCE_FITNESS_SUPABASE_ANON_KEY  public anon/publishable key
...
Important:
- Requires the shared-access RLS migration (backend/migrations/0003_agent_access.sql).
